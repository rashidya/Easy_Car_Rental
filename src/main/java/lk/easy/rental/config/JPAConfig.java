...
public class JPAConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setDriverClassName(environment.getRequiredProperty("driver.classname"));
        return dataSource;
    ...
    public JpaVendorAdapter jpaVendorAdapter() {
        ...
        vendor.setDatabasePlatform(environment.getRequiredProperty("database.platform"));
